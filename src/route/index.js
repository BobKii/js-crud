...
router.get("/", function (req, res) {
  ...
  let allPlayList = Playlist.getList();
  console.log(`== start =====  router.get("/index", =====`);
...
router.get("/spotify-track-add", function (req, res) {
  console.log(`== start =====  router.get("/spotify-track-add" =====`);
  console.log(req.body, req.query);
  console.log(`== start =====  router.get("/spotify-track-add" =====`);
...
router.post("/spotify-track-add", function (req, res) {
  console.log(`== start ==}===  router.post("/spotify-track-add", =====`);
  console.log(req.body, req.query);
  console.log(`== start =====  router.post("/spotify-track-add", =====`);
  ...
  if (!playlist) {
    return res.render("alert", {
      ...
      data: {
        message: "Помилка",
        info: ["Такого плейліста не знайдено", "Помилка"],
        // link: /spotify-playlist?id=${playlistId},
      },
    });
  }
  ...
  if (!trackToAdd) {
    return res.render("alert", {
      ...
      data: {
        message: "Помилка",
        info: ["Такого треку не знайдено", "Помилка"],
